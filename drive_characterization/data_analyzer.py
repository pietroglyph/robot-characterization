...
class ProgramState:
    def __init__(self):
        ...
        self.wheelbase_diameter.set('N/A')
...
def configure_gui():
    ...
    def runAnalysis():
        ...
        if 'wheelbase-diameter' in STATE.stored_data:
            STATE.wheelbase_diameter.set('%s' % float("%.3g" %
                calcWheelbaseDiameter(STATE.stored_data['wheelbase-diameter'])))
...
# This intentionally doesn't include wheelbase-diameter, because it doesn't go
# through the normal preparation pipeline
...
def calcWheelbaseDiameter(table):
    ...
    if diameter < 0:
        ...
        print("This means that your gyro is returning clockwise positive angles.")
        print("Use counterclockwise positive angles instead.")
